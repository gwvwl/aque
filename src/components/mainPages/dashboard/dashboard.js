        ...
        <div className="tabs__action__left">
            <div className="tabs__action__left__user">
                ...
                <div className="action__users__button">
                    ...
                    <NavLink to='/menu/my-patients' 
                            className='action__users__links'>Go to Patient Profil</NavLink>
                </div>
            </div>
            <div className="action__users__promo">
                <span>Lorem ipsum dolor sit, amet consectetur adipisicing elit. At tempora delectus, rem quam mollitia enim consectetur ad quas ut dolorem blanditiis dolore optio explicabo, labore perspiciatis cumque deserunt fugit. Labore.
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eum, placeat deserunt cum laborum id accusantium dolore quod deleniti labore obcaecati laudantium autem unde! Aperiam, saepe. Laboriosam consectetur perspiciatis dolorum qui!
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus, repellat est. Minus rem dolorum numquam nulla delectus odit quos earum iste? Nemo ratione beatae, expedita ipsum eveniet cumque consequatur ea!
                </span>
            </div>
        </div>
    )
...
const TabsActionRight = () => {
    return(
        <div className="tabs__action__right">
            ...
            <span className='tabs__action__right__list'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi dicta earum, saepe voluptatibus, nemo odio ullam quisquam atque cum ad incidunt deleniti hic! Vero labore similique cumque. Laborum, odit harum.Lorem Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorum, assumenda, accusantium unde rem maiores vero molestiae nihil ad veniam ea blanditiis! Corrupti suscipit nemo dignissimos ad id voluptatibus, maiores asperiores.</span>
